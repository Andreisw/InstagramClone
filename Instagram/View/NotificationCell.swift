...
class NotificationCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        postImageView.anchor(right:rightAnchor,paddingRight: 12,width: 35,height: 35)
    ...
    func configure() {
        ...
        followButton.isHidden = !viewModel.shopudlHidePostImage
        postImageView.isHidden = viewModel.shopudlHidePostImage
